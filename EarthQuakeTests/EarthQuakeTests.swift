...
class EarthQuakeTests: XCTestCase {
    ...
    */
    func testGetEarthQuakeDataSuccessAt30() {
        ...
        //set up stub to use
        if let quakeUrl = NSURL(string: EarthQuakes.quakeURL) {
    ...
    */
    private func buildEarthQuakeExpectedList() -> [EarthQuake] {
        ...
        earthQuakes.append(EarthQuake(lattitude: "41.8654", longitude: "-119.599", dateString: "Mon, 05 Dec 2015 04:35:47 +0000", title: "3.25 - 23.1 miles NE of Vya,NV", link: "http://earthquake.usgs.gov/eqcenter/shakemap/nn/shake/00513400/", floorMagnitude: "3"))
